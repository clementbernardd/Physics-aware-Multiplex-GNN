...
def get_rms(molecule_file):
    return 0.0
    # return os.path.basename(molecule_file).replace(".pdb", "")
...
def construct_graphs(data_dir, save_dir, save_name):
    print("Preprocessing", data_dir)

    data_dir_full = data_dir
